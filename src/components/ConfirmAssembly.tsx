...
import { Rocket, Code, Database, Network, ChevronRight, Info, Check } from 'lucide-react';
...
export const ConfirmAssembly: React.FC<ConfirmAssemblyProps> = ({ setScreen }) => {
  return (
        ...
        <section className="col-span-12 flex flex-col md:flex-row items-center justify-between gap-6 py-8 px-8 bg-[#e6f6ff] rounded-2xl border border-[#0056c5]/10 mb-12">
          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
            ...
            <button 
              ...
              className="flex-1 md:flex-none px-12 py-3 rounded-xl bg-gradient-to-b from-[#0056c5] to-[#0f6df3] text-white font-extrabold shadow-md hover:opacity-90 active:scale-95 transition-all text-sm"
            >
              Create Application
            </button>
          </div>
